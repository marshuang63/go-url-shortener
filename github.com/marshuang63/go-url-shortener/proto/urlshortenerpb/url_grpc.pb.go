...
const (
	URLShortener_ShortenURL_FullMethodName = "/urlshortenerpb.URLShortener/ShortenURL"
	URLShortener_ExpandURL_FullMethodName  = "/urlshortenerpb.URLShortener/ExpandURL"
)
...
func (c *uRLShortenerClient) ExpandURL(ctx context.Context, in *ExpandRequest, opts ...grpc.CallOption) (*ExpandResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedURLShortenerServer) ExpandURL(context.Context, *ExpandRequest) (*ExpandResponse, error) {
...
func _URLShortener_ExpandURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(URLShortenerServer).ExpandURL(ctx, req.(*ExpandRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var URLShortener_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "urlshortenerpb.URLShortener",
